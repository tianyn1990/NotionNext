...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://tianyn.notion.site/api/v3' || 'https://www.notion.so/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  // Important page_id！！！Duplicate Template from  https://tanghh.notion.site/02ab3b8678004aa69e9e415905ef32a5
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID ||
    '2831ba6e6fe280e0aa1adb9928f12151',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'tianyn1990', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.tianyn1990.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'blog, tianyn1990, 博客', // 网站关键词 英文逗号隔开
